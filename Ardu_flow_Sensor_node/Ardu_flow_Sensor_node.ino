...
const char METER_1_DEVICE_ID[ ] = "WTR_PUN_00001_2016";
...
void loop() {
  ...
  Serial.println("-----------------------------");
  Serial.print("Total Main Pipeline flow rate : ");
  Serial.print(totalFlowRate);
  Serial.println(" L/Min");
  Serial.println("---------");
  Serial.print("Meter no. 1, Meter/consumer no. ");
  Serial.print(METER_1_DEVICE_ID);
  Serial.print(" Reading: ");
  Serial.print(meter1FlowRate);
  Serial.println(" L/Min");
  Serial.println("---------");
  Serial.print("Meter no. 2, Meter/consumer no. ");
  Serial.print(METER_1_DEVICE_ID);
  Serial.print(" Reading: ");
  Serial.print(meter2FlowRate);
  Serial.println(" L/Min");
  Serial.println("---------");
  Serial.print("Meter no. 3, Meter/consumer no. ");
  Serial.print(METER_3_DEVICE_ID);
  Serial.print(" Reading: ");
  Serial.print(meter3FlowRate);
  Serial.println(" L/Min");
  Serial.println("---------");
